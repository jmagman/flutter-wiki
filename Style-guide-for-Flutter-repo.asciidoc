...
All code in all Flutter repositories must be contributed by developers who have signed https://cla.developers.google.com/[the Google CLA], except if it is "third party code".
