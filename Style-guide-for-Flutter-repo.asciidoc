...
Optimize for readability. Write detailed documentation. Test everything.
Avoid `is`, `print`, `part of`, `extension` and `_`.
No timeouts or timers.
...
large file size. In Flutter, this is considered to be more preferable than creating
