...
Any references to the Flutter java API will need to be done within your newly setup dynamic feature module. You are no longer able to directly launch a `FlutterActivity` from your main activity and must now wrap it in a new class inside your dynamic feature module.
