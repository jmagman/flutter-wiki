Flutter has installation bundles which you can download and install for [beta channel](https://github.com/flutter/flutter/wiki/Flutter-build-release-channels).
